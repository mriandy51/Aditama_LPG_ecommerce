...
def generate_financial_report_pdf(start_date, end_date, orders, total_revenue, online_revenue, offline_revenue):
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
...
def generate_pdf():
    ...
    pdf = generate_financial_report_pdf(
        start_date_obj,
        end_date_obj - timedelta(days=1),  # Kurangi 1 hari sebab tambah 1 hari sebelumnya
        orders,
        total_revenue,
        online_revenue,
        offline_revenue
